...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grepl(db, input): input string 28 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grepl(db, input): input string 31 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grepl(db, input): input string 36 is invalid in this locale}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grep("{}\textasciicircum{}\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}bibliography.+"{}, input, value = TRUE): input string 28 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grep("{}\textasciicircum{}\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}bibliography.+"{}, input, value = TRUE): input string 31 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grep("{}\textasciicircum{}\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}bibliography.+"{}, input, value = TRUE): input string 36 is invalid in this locale}}\end{kframe}
\end{knitrout}
...
\caption{Розкластерований датасет <<Іриси Фішера>> при $m=12$, $\beta=4$ (Точність кластерування $\approx 96\%$)}
\label{fig:3DClusteredIrisDatasetM12Beta4.pdf}
\end{center}
\end{figure}
