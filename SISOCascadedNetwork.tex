...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grepl(db, input): input string 24 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grepl(db, input): input string 27 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grepl(db, input): input string 32 is invalid in this locale}}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grep("{}\textasciicircum{}\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}bibliography.+"{}, input, value = TRUE): input string 24 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grep("{}\textasciicircum{}\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}bibliography.+"{}, input, value = TRUE): input string 27 is invalid in this locale}}

{\ttfamily\noindent\color{warningcolor}{\#\# Warning in grep("{}\textasciicircum{}\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}bibliography.+"{}, input, value = TRUE): input string 32 is invalid in this locale}}\end{kframe}
\end{knitrout}
...
\begin{figure}
\begin{center}
\includegraphics[width=17cm]{ENFNSynapse.eps}
\caption{Синапс розширеного нео-фаззі нейрону $ENS$
...
наведено на рис.~\ref{fig:ENFNSynapse} та рис.~\ref{fig:CasCorLA} відповідно.
