...
<<intro, child='xampl-intro.Rnw'>>=%       Вступ
@


<<chapter1, child='xampl-ch1.Rnw'>>=%         Розділ 1
@
...
<<chapter2, child='xampl-concl.Rnw'>>=%       Висновки
@

%<<chapter2, child='xampl-bib.Rnw'>>=
%@
%\include{xampl-bib}%         Список використаних джерел (+список публікацій автора)
%\appendix
