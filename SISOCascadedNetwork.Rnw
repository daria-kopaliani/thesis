...
У випадку, коли $s=1$ \eqref{eq:GeneralizedOutputPacketMode} та \eqref{eq:GeneralizedOutputRecurrent} приймають доволі простий вигляд:
